#ifndef HALIDE__build___libabnr_gen_h
#define HALIDE__build___libabnr_gen_h
#include <stdint.h>
...
int libabnr_gen(struct halide_buffer_t *_input_buffer, int32_t _anchor_idx, struct halide_buffer_t *_merge_spatial_output_buffer) HALIDE_FUNCTION_ATTRS;
int libabnr_gen_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *libabnr_gen_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return libabnr_gen_metadata;
}
#endif


int libabnr_gen_old_buffer_t(struct buffer_t *_input, int32_t _anchor_idx, struct buffer_t *_merge_spatial_output) HALIDE_FUNCTION_ATTRS;
